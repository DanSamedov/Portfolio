        ...
        <div className="grid md:grid-cols-5 gap-8 md:gap-12 items-start">
          <div className="md:col-span-2 text-center md:text-left space-y-4">
            ...
            <a
              ...
              className="group relative inline-block w-32 h-10 cursor-pointer overflow-hidden rounded-full border border-border bg-white/90 shadow-sm p-2 text-center font-semibold no-underline"
            >
